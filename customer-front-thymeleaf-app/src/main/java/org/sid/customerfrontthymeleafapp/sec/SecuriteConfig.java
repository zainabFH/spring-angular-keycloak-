package org.sid.customerfrontthymeleafapp.sec;
...
public class SecuriteConfig {
    ...
    public SecuriteConfig(ClientRegistrationRepository clientRegistrationRepository) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        return http
                ...
                //ça necessite pas une authentification
